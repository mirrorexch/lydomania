    ...
    >
        {({ isActive }) => (
            <>
                ...
                {isActive && <span className="ml-auto w-1.5 h-1.5 rounded-full bg-cyber-cyan shadow-[0_0_8px_rgba(0,240,255,0.7)]" />}
            </>
        )}
    </NavLink>
);
    ...
    return (
        ...
        >
            ...
            <nav className="flex flex-col gap-1 flex-1 overflow-y-auto">
                ...
                <Item to="/friends" icon={Users} label={t("nav.friends")} testid="side-nav-friends" />
                {isAdmin && (
