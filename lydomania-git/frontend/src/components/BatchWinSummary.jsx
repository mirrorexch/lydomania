                            ...
                            {sortedRolls.map((r, i) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="aspect-square bg-cyber-bg rounded-lg relative overflow-hidden"
                                    ...
                                    >
                                        <img
                                            ...
                                            draggable={false}
                                        />
                                        <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/85 to-transparent px-1 pb-0.5 pt-2 text-center">
