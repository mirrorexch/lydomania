...
import { Shield, Inbox, Box, Layers, SlidersHorizontal, Ticket, Activity, Users, Diamond, Settings as Cog, Link2 } from "lucide-react";
    ...
    return (
        <main className="mx-auto px-4 sm:px-6 pt-3 pb-24 lg:pb-6
            ...
            <div className="flex gap-1.5 mb-3 overflow-x-auto pb-1">
                ...
                <Tab to="/admin/tonapi-mappings" icon={Link2} label={t("admin_tonapi.tab")} testid="admin-subnav-tonapi-mappings" />
